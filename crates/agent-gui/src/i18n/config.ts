...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.skillsHubEnabled": "技能已启用",
    "settings.skillsHubDisabled": "技能未启用",
    "settings.skillsHubSelectedShort": "已选",
    "settings.skillsHubEnabledHint": "在对话中按需注入已选技能能力",
    "settings.skillsHubDisabledHint": "开启后，可在对话中按需注入技能",
  ...
  "en-US": {
    ...
    "settings.skillsHubEnabledHint": "Selected skills are injected into conversations when needed",
    "settings.skillsHubDisabledHint": "Enable Skills to inject skills into conversations when needed",
